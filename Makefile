...
out: src/counter.cpp src/main.cpp
	$(CC) $(CFLAGS) -o out src/counter.cpp src/main.cpp src/noisy_counter.cpp src/util.cpp src/adaptive_noisy_counter.cpp src/onesided_adaptive_noisy_counter.cpp
